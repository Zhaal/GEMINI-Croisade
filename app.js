...
const phases = [
  // ===== ROUND 1 =====
  {
    ...
    choix: [
        {
          texte: "Rediriger l’énergie vers les batteries anti-aériennes",
          fluff: `Les canons fendent le ciel, abattant une pluie de spores enflammées.`,
          bonus: `Choisissez une unité Tyranide d'Infanterie ou de Bêtes. Elle subit D6+3 blessures mortelles. En contrepartie, jusqu'à votre prochaine phase de commandement, les unités ennemies ajoutent 1 à leurs jets pour toucher contre vos unités lorsqu'elles effectuent une attaque de tir.`,
          tag: "Faveur majeure",
          effet: { ...effMap["Faveur majeure"] },
        },
        {
          texte: "Renforcer les champs magnétiques",
          fluff: `Le promontoire tremble sous une barrière invisible qui crépite dans l’air sec.`,
          bonus: `Vos unités de Véhicules gagnent +1 à leurs jets de sauvegarde jusqu'au début de votre prochaine phase de commandement. En contrepartie, toutes vos unités ont -1 à leur caractéristique d'Attaques ce tour (minimum 1).`,
          tag: "Faveur mineure",
          effet: { ...effMap["Faveur mineure"] },
        },
        {
          texte: "Envoyer des éclaireurs à travers les dunes",
          fluff: `Une patrouille disparaît dans la tempête, revenant mutilée.`,
          bonus: `Retirez 1 de vos unités d'Infanterie du champ de bataille. Vous pouvez la replacer n'importe où sur le champ de bataille à la fin de votre prochaine phase de mouvement, à plus de 9" des unités ennemies (Frappe en Profondeur).`,
        ...
        },
        {
          ...
          bonus: `L'adversaire peut immédiatement placer sur la table 2 unités Tyranides de son choix (en respectant la cohérence et à plus de 9" de vos unités). En contrepartie, jusqu'à votre prochaine phase de commandement, vos unités relancent tous leurs jets pour toucher ratés lorsqu'elles tirent.`,
  ...
  },
  {
    ...
    choix: [
        {
          texte: "Concentrer les tirs sur une cible prioritaire",
          fluff: `Un mur de feu écrase une cible.`,
          bonus: `Choisissez une unité ennemie visible à 24" d'une de vos unités. Cette unité ennemie subit 3D3 blessures mortelles.`,
          tag: "Faveur majeure",
          effet: { ...effMap["Faveur majeure"] },
        },
        {
          ...
          bonus: `Jusqu'au début de votre prochaine phase de charge, toutes vos unités ajoutent 1 à leurs jets de touche lorsqu'elles effectuent un Tir en État d'Alerte (Overwatch).`,
          tag: "Faveur mineure",
          effet: { ...effMap["Faveur mineure"] },
        },
        {
          texte: "Piéger la zone avec des mines",
          fluff: `Les premiers assaillants explosent dans un nuage de chitine.`,
          bonus: `Placez deux marqueurs n'importe où sur le champ de bataille, à plus de 3" d'une unité. La première fois qu'une unité ennemie se déplace sur un de ces marqueurs, elle subit D3 blessures mortelles et le marqueur est retiré.`,
          tag: "Défaveur mineure",
          effet: { ...effMap["Défaveur mineure"] },
        },
        {
          texte: "Se retrancher sur le cœur défensif",
          fluff: `Les lignes se resserrent, mais l’ennemi progresse.`,
          bonus: `Jusqu'à votre prochaine phase de charge, chaque fois qu'une unité ennemie termine un mouvement de charge, elle subit D3 blessures mortelles.`,
          tag: "Défaveur majeure",
          effet: { ...effMap["Défaveur majeure"] },
        },
    ],
    ...
    choix: [
        {
          ...
          bonus: `Toutes vos unités situées à 18" ou moins de votre Seigneur de Guerre peuvent immédiatement effectuer un mouvement normal de 6".`,
          tag: "Faveur majeure",
          effet: { ...effMap["Faveur majeure"] },
        },
        {
          ...
          bonus: `Chaque unité alliée située à 18" ou moins de votre Seigneur de Guerre récupère D3 points de vie perdus.`,
          tag: "Faveur mineure",
          effet: { ...effMap["Faveur mineure"] },
        },
        {
          ...
          bonus: `Choisissez une de vos unités à 9" ou moins de votre Seigneur de Guerre ; elle subit D3 blessures mortelles. En contrepartie, jusqu'à votre prochaine phase de commandement, toutes les autres unités alliées à 18" de votre Seigneur de Guerre réussissent automatiquement leurs tests de moral.`,
          tag: "Défaveur mineure",
          effet: { ...effMap["Défaveur mineure"] },
        },
        {
          ...
          bonus: `Jusqu'à votre prochaine phase de commandement, les unités alliées situées à 12" ou moins de votre Seigneur de Guerre réussissent automatiquement leurs tests de moral.`,
          tag: "Défaveur majeure",
          effet: { ...effMap["Défaveur majeure"] },
        },
    ],
